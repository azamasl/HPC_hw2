/**
Since there are two sections (1 and 2) which are trying to read a and b at the same time it creates a deadlock in the run time. BY defining a and b to be private we prevent the deadlock.
 */
#include <omp.h>
#include <stdio.h>
#include <stdlib.h>
...
#pragma omp parallel private(c,i,tid,section,a,b)
  {
